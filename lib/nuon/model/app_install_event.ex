...
defmodule Nuon.Model.AppInstallEvent do
  ...
  @type t :: %__MODULE__{
    ...
    :operation => Nuon.Model.GithubComPowertoolsdevMonoServicesCtlApiInternalAppInstallsWorkerSignalsOperation.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:operation, :struct, Nuon.Model.GithubComPowertoolsdevMonoServicesCtlApiInternalAppInstallsWorkerSignalsOperation)
