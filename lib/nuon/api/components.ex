...
defmodule Nuon.Api.Components do
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_component_builds(Tesla.Env.client, String.t, keyword()) :: {:ok, list(Nuon.Model.AppComponentBuild.t)} | {:ok, Nuon.Model.StderrErrResponse.t} | {:error, Tesla.Env.t}
