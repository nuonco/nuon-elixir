...
defmodule NuonAPI.Model.AppInstallSandboxRun do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :run_type => NuonAPI.Model.AppSandboxRunType.t | nil,
    :status => String.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:run_type, :struct, NuonAPI.Model.AppSandboxRunType)
  end
end
