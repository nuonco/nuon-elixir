...
defmodule NuonAPI.Model.AppConnectedGithubVcsConfig do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :vcs_connection => NuonAPI.Model.AppVcsConnection.t | nil,
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:vcs_connection, :struct, NuonAPI.Model.AppVcsConnection)
  end
end
