...
defmodule NuonAPI.Connection do
  @moduledoc """
  Handle Tesla connections for NuonAPI.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:nuon_api, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - NuonAPI 0.19.13 - elixir"
        )
      )
